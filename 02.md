...
Please be patient. This gets resolved by Day 3. :)


# 01 Hands On: DC/OS Scale

Let's start with a simple cluster setup:

1. [Git](https://git-scm.com/downloads), [Vagrant](https://www.vagrantup.com/downloads.html), and [VirtualBox](https://www.virtualbox.org/wiki/Downloads)
